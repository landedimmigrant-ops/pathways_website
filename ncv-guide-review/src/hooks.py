...
def note_after_table(text):
    ...
    note = ('\n<div class="c-box box section"><div class="bloc d-tint p-4 pb-1 mt-4 mb-4" style="border-left: 4px solid #912338;">'
            ...
            '<p><span class="xlarge-text" style="color: #912338;"><!--rv:P-49--><b><u>You must use the agency\'s template.</u></b></span></p>'
            '<p><span class="xlarge-text">Prepare your TCV or CV-FRQ in the current version of the template your agency provides, '
            "and keep the formatting it sets. <!--rv:P-44--><b><u style=\"color: #912338;\">Do not exceed the page limit.</u></b> The FRQ is especially strict "
