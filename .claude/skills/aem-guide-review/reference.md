...
- SSHRC/CIHR: 12-pt Arial, exception for tables/figures/legends. NSERC: 12-pt Times New Roman for
  all text (NSERC told Prem: no exception; its published footnote says otherwise). CV-FRQ: TNR 12.
