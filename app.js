(() => {
  ...
  const buildAbout = () => {
    ...
    if (aboutSectionById.contact) {
      ...
      // Triage contact form
      // Embedded Microsoft Form (replaces the former Formspree contact form).
      // The #contact-form id is preserved so existing "Contact us" CTAs still anchor here.
      const contactFormWrap = el("div", "contact-msform-wrap");
      contactFormWrap.id = "contact-form";
      const contactFormFrame = el("iframe", "contact-msform");
      contactFormFrame.src = "https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=hfFpVS_SE06YUM5bGrzS6PfZycU56VhFhWbM6yJ0d1lUMDJJUkM0V1BGTzRMU0M4TEg4VDNGM1c1TiQlQCN0PWcu&embed=true";
      contactFormFrame.title = "Pathways to Impact contact form";
      contactFormFrame.setAttribute("frameborder", "0");
      contactFormFrame.setAttribute("allowfullscreen", "");
      contactFormFrame.loading = "lazy";
      contactFormFrame.style.width = "100%";
      contactFormFrame.style.height = "720px";
      contactFormFrame.style.border = "1px solid var(--border)";
      contactFormWrap.appendChild(contactFormFrame);
      contactSection.appendChild(contactFormWrap);
